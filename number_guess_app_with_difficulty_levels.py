...
if language.lower() == "en":
            ...
            def start_game():
                    ...
                    while wanna_play.lower() == "yes":
                        try:
                            guess = input("Pick a number between {} and {} ".format(first_number, second_number))
            ...
            def show_score():
                    if len(attempts_list) <= 0:
                        print("En yüksek skor bulunmamaktadır, en yüksek skorun yeni sahibi olmaya çalışın!")
                    else:
